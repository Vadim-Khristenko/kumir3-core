...
impl ExprEvaluator {
    ...
    fn eval_new_instance(
        ...
        if !class.constructors.is_empty() {
            ...
            let obj = Value::Object {
                type_id: shared::types::TypeId(0), // TODO: proper type id
                fields: fields.clone(),
            };
    ...
    pub fn default_value_for_type(type_spec: &TypeSpec) -> Value {
        match type_spec {
            ...
            TypeSpec::Float128 => Value::Number(Number::F128(shared::f128::F128::from(0.0))),

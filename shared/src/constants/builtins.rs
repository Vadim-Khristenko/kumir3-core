...
pub static BUILTIN_MATH_FUNCTIONS: &[&str] = &[
    ...
    "arcsin", "arccos", "arctg", "arctan", "arcctg", "arccot",
    
    // Гиперболические
    "sh", "sinh", "ch", "cosh", "th", "tanh",
    
    // Степенные и логарифмы
    "sqrt", "корень", "exp", "ln", "lg", "log",
    "степень", "pow",
    
    // Округление
    "abs", "модуль", "sign", "знак",
    "int", "цел_часть", "frac", "дробь",
    "floor", "ceil", "round", "округл",
...
pub static BUILTIN_STRING_FUNCTIONS: &[&str] = &[
    ...
    "символ", "char", "chr",
    "код", "ord", "code",
    "вырезка", "substr", "substring",
    "позиция", "pos", "position", "find",
    "заменить", "replace",
    "верхний", "upper", "uppercase",
    "нижний", "lower", "lowercase",
    "обрезать", "trim",
    "слева", "left",
    "справа", "right",
    "повторить", "repeat",
...
pub static BUILTIN_IO_FUNCTIONS: &[&str] = &[
    "ввод", "input",
    "вывод", "output", "print",
    "вывод_строки", "println",
    "новая_строка", "newline", "нс",
];

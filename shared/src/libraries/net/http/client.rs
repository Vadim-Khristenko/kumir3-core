...
use crate::libraries::net::tcp::{TcpConnection, TcpConfig};
use crate::libraries::net::tls::{TlsConfig, TlsConnector};
...
impl HttpClient {
    ...
    pub fn from_network_config(net_config: crate::libraries::net::NetworkConfig) -> Self {
        Self {
            config: HttpClientConfig {

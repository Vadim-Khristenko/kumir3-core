...
use crate::shared::codegen::rust_block::{RustBlockExecutor, RustBlockConfig, RustExecutionMode};
...
impl Executor {
    ...
    pub fn execute(stmt: &Stmt, env: &mut Environment) -> RuntimeResult<ControlFlow> {
        match stmt {
            ...
            Stmt::StructDecl { name, fields } => {
                ...
                let class = crate::shared::types::ClassDef {
                    name: name.clone(),
                    parent: None,
                    interfaces: vec![],
                    fields: fields.clone(),
    ...
    fn execute_interface_decl(
        name: &str,
        methods: &[crate::shared::types::MethodSignature],
        env: &mut Environment,
    ) -> RuntimeResult<ControlFlow> {
        use crate::shared::types::InterfaceDef;
    ...
    fn execute_trait_decl(
        name: &str,
        methods: &[crate::shared::types::Method],
        env: &mut Environment,
    ) -> RuntimeResult<ControlFlow> {
        use crate::shared::types::{TraitDef, TraitMethod, MethodSignature};
    ...
    fn execute_impl_block(
        ...
        use crate::shared::types::ImplDef;
